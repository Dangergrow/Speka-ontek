...
class Api:
    ...
    def apply_update(self):
        """Скачать ВСЕ файлы обновления в папку с программой"""
        try:
            app_dir = get_app_dir()
...
def setup_files():
    """Копирует файлы из MEIPASS в папку с EXE при первом запуске"""
...
def main():
    ...
    # ВСЕГДА используем папку с EXE, а не _MEIPASS
